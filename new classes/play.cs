...
namespace DataBaseProject
{
    class play
    {
        ...
        public play(string playerid,string gameid,int ngoal,int tplayed,int npass,int grade,int ncpass,int nscore,int sscore)
        {
        ...
        {
            play emp = new play("8", "3/9/79", 10,10,10,90,10,0,10);
            play emp1 = new play("10", "5/9/79", 14, 10, 90, 90, 10, 0, 0);
            play emp2 = new play("10", "3/9/79", 13, 10, 17, 90, 9, 0, 0);
            play emp3 = new play("11", "3/9/79", 15, 15, 10, 90, 10, 0, 0);
            emp.insert();
