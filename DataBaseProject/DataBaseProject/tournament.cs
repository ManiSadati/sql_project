...
namespace DataBaseProject
{
    class tournament
    {
        ...
        {
            string query = "SELECT * FROM tournament where dname='" + name + "'";
            ...
            if (ans.Rows.Count > 0)
            {
                ...
                emp.wteam = ans.Rows[0]["wteam"].ToString();
                emp.drank = Convert.ToInt32(ans.Rows[0]["drank"].ToString());
                emp.prise = ans.Rows[0]["prise"].ToString();
                emp.point = Convert.ToInt32(ans.Rows[0]["point"].ToString());
                emp.season = ans.Rows[0]["season"].ToString();
            }
            return emp;
        }
        public void insert()
